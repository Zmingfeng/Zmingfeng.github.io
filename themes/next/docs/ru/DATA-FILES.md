...
Реализация `theme_config` в Hexo менялась несколько раз. Чтобы избежать проблем, необходимо обновиться до Hexo 4.2.0 (или выше) для использования этой возможности.
